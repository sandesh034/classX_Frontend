                        ...
                        <div className="flex items-center lg:order-2">
                            ...
                            >
                                ...
                                <svg aria-hidden="true" className="w-6 h-6" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg" >
                                    <path clipRule="evenodd" fill-rule="evenodd" d="M8 4a4 4 0 100 8 4 4 0 000-8zM2 8a6 6 0 1110.89 3.476l4.817 4.817a1 1 0 01-1.414 1.414l-4.816-4.816A6 6 0 012 8z"></path>
                                </svg>
                            </button>
                            {/* <!-- Notifications --> */}
                            <button
                            ...
                            >
                                ...
                                <img
                                    ...
                                    src={localStorage.getItem('user') ? JSON.parse(localStorage.getItem('user')).image : './user.png'}
                                    alt="user photo"
                        ...
                        <ul className="space-y-2">
                            ...
                            <li>
                                ...
                                >
                                    ...
                                    <span className="flex-1 ml-3 whitespace-nowrap">Discussion</span>
